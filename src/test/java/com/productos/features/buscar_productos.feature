Feature: Búsqueda y filtrado de productos
  ...
  Scenario: Buscar productos con filtros
    When I search for products with filters:
      ...
      | Electronica | 300000  | COL       |
    Then I should receive the following products:
      | nombre                                 | categoria  | precio   | ubicacion |
      | Televisor Samsung 55                   | Electronica| 3000000  | COL       |
      | Apple AirPods Pro (2ª generación)       | Electronica| 1300000  | COL       |
      | Smart TV LG AI ThinQ 4K 60"             | Electronica| 2000000  | COL       |

  Scenario: Buscar productos por texto
    When I search for products by text "JBL"
    Then I should receive the following products:
      | nombre                                 | categoria  | precio   | ubicacion |
      | Audífonos inalámbricos JBL             | Electronica| 249000   | COL       |
      | Parlante JBL Charge 5 portátil         | Electronica| 890000   | COL       |
  ...
  Scenario: Obtener sugerencias de autocompletado
    When I request autocomplete suggestions for text "A"
    Then I should receive the following suggestions:
      | suggestion                            |
      | Audífonos inalámbricos JBL            |
